...
def app_driver():
    ...
    try:
        ...
        options.load_capabilities({
            "appium:appPackage": "com.tongjiwisdom",
            ...
            "appium:noReset": False,  # Reset the app state. 1. True: Do not reset; 2. False: Reset.
            "appium:connectHardwareKeyboard": True,
            "appium:chromedriverExecutable": driver_path,
            "appium:clearSystemFiles": True,  # Clear cache. 1. True: Clear; 2. False: Do not clear.
        })
